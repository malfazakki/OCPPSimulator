...
const defaultSEO = {
	title: "Malfa OCPP Simulator - EV Charging Station Testing Lab",
	description:
		"Web-based Malfa OCPP simulator for testing Electric Vehicle charging stations, OCPP 1.6-J protocols, smart metering telemetry, and CSMS integrations.",
	keywords:
		"Malfa OCPP, EV charging, electric vehicle, charging station, OCPP simulator, charge point, CSMS, EV testing, OCPP 1.6-J, WebSocket, charging protocol",
	image: "/og-image.png",
	type: "website",
	siteName: "Malfa OCPP Simulator",
	twitterHandle: "@malfa_ocpp",
};

export function SEO({ title, description, keywords, image, type, url }: SEOProps) {
